...
import numpy as np
Image.fromarray(np.zeros((100,100,3), dtype=np.uint8)).save('_test.png')
r = requests.post('http://127.0.0.1:8001/extract_single?model_name=resnet50', files={'file': open('_test.png','rb')},
